...
2. for each of the directories (excluding `.claude`):
    - use `mcp__agent-launch` to launch the `codebase-locator` and `codebase-analyzer` agents to locate the key parts of the codebase. Wait for it to finish
